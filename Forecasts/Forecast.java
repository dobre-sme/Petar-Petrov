...
public class Forecast {
    ...
    public Forecast(double longitude, double latitude, double averageTemperature, double temperatureFeelsLike,
                    int rainChancePercentage, int snowChancePercentage, int thunderstormPercentage,
                    double windVelocityInKilometersPerHour, double humidity, double atmosphericPressureInBars) {
